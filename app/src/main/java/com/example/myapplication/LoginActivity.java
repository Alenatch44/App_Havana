...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button mGenerateBtnExit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCountryCode.setText("+7");
        mPhoneNumber = findViewById(R.id.phone_number_text);
        mGenerateBtn = findViewById(R.id.generate_btn);
        mLoginProgress = findViewById(R.id.login_progress_bar);
        mLoginFeedbackText = findViewById(R.id.login_form_feedback);
        mGenerateBtnExit = findViewById(R.id.generate_btn_exit);
        ...
        mGenerateBtnExit.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(final String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                new android.os.Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                Intent otpIntent = new Intent(LoginActivity.this, CodeActivity.class);
