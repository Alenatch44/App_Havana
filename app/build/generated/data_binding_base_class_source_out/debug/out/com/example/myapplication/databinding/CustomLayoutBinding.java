...
public final class CustomLayoutBinding implements ViewBinding {
  ...
  private CustomLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static CustomLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomLayoutBinding((ConstraintLayout) rootView, imageView);
    }
